...
function chargerDonneesDemo() {
    ...
    setTimeout(() => {
        const donneesDemo = [
            { matiere: 'fr', notes: [12.50, 14.25, 13.33, 15.75], compo: 14.50 },
            { matiere: 'ang', notes: [10.25, 11.75, 12.33, 13.67], compo: 11.50 },
            { matiere: 'maths', notes: [15.25, 16.33, 14.67, 17.25], compo: 15.50 },
            { matiere: 'pc', notes: [13.75, 14.25, 12.67, 15.33], compo: 13.50 },
            { matiere: 'philo', notes: [14.33, 15.67, 13.25, 16.75], compo: 14.50 },
            { matiere: 'all', notes: [16.25, 17.33, 15.67, 18.25], compo: 16.50 }
        ];
